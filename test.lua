...
SimplePath.__index = function(table, index)
...
--[[ STATIC METHODS ]]--
function SimplePath.GetNearestCharacter(fromPosition)
...
--[[ CONSTRUCTOR ]]--
function SimplePath.new(agent, agentParameters, override)
